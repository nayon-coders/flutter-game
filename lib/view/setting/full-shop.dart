...
import 'package:mboile_game/view/setting/full-payments.dart';
import 'package:mboile_game/view/setting/shop/payments.dart';
import 'package:mboile_game/view/wallet/add-money/wallets.dart';
import 'package:mboile_game/view/widgets/list-tile.dart';

import 'package:sizer/sizer.dart';


class FullShop extends StatefulWidget {
  const FullShop({Key? key}) : super(key: key);

  @override
  State<FullShop> createState() => _FullShopState();
}

class _FullShopState extends State<FullShop> {
  List Product = [
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                ...
                                InkWell(
                                  onTap: (){
                                    Navigator.push(context, MaterialPageRoute(builder: (context)=>FullPayments()));
                                  },
                                  child: Container(
                                    width: 150,
                                    decoration: BoxDecoration(
